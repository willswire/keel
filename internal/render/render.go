...
func Generate(opts Options) error {
	...
	ports := buildTemplatePorts(opts.App.Dockerfile.ExposedPorts)
	runAsNonRoot, hasRunAsUser, runAsUser := userSecurity(opts.App.Dockerfile.User)
...
func writeZarfConfig(opts Options) error {
	...
	pkg.Metadata.Description = fmt.Sprintf("Generated by keel from %s", opts.App.DockerfilePath)
...
func parseDockerArgs(raw string) []string {
